...
export function BlogListHero() {
  return (
    <section className="relative h-[350px] md:h-[750px]  overflow-hidden">
      ...
      {/* Content */}
      <div className="relative h-full flex flex-col items-start justify-center px-3 xs:px-4 sm:px-6 lg:px-10 z-10">
        <motion.p 
  ...
  <Button 
    size="lg" 
    className="relative overflow-hidden bg-[#209F00] hover:bg-[#30dd05] cursor-pointer text-white rounded-full px-15 py-7 text-md group w-full"
  >
