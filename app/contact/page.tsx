...
export const metadata = {
  ...
  keywords: 'contact manal healthcare, healthcare contact, book appointment, emergency services, patient support, healthcare inquiries, hospital contact, medical consultation, schedule appointment, patient care',
  openGraph: {
    title: 'Contact Manal Healthcare - 24/7 Support Available',
    description: 'Get in touch with our healthcare team. Available 24/7 for your medical needs. Book appointments, inquiries, and emergency support.',
    type: 'website',
    images: [{
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 px-3 xs:px-4 sm:px-6 lg:px-10">
      ...
      <section className="py-16 px-3 xs:px-4 sm:px-6 lg:px-10 bg-gray-50">
        <div className="container mx-auto">
