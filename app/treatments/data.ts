...
export const treatmentsData: Treatment[] = [
  ...
  },
  {
    ...
    category: 'Cardiac Surgery',
    overview: 'Life-saving open-heart surgery to improve blood flow to the heart muscle by creating new routes around blocked arteries.',
  ...
  },
  {
    ...
    overview: 'Surgical procedure to permanently connect vertebrae in the spine, treating degenerative disc disease, spinal stenosis, and scoliosis.',
  ...
  },
  {
    ...
    overview: 'Emergency stroke care with 24/7 rapid response, using clot-busting medications and mechanical thrombectomy to minimize brain damage.',
  ...
  },
  {
    ...
    overview: 'Comprehensive treatment options for enlarged prostate and prostate cancer with minimally invasive procedures and personalized care plans.',
  ...
  },
  {
    ...
    overview: 'Expert surgical repair of various hernias using advanced techniques with mesh materials for lasting results and minimal recurrence.',
  ...
  },
  {
    ...
    overview: 'Comprehensive cancer treatment using latest chemotherapy protocols with personalized plans and advanced supportive care.',
  ...
  {
    id: '12',
    slug: 'rhinoplasty-surgery',
    title: 'Rhinoplasty Surgery',
    category: 'Cosmetic Surgery',
    overview: 'Aesthetic and functional nose surgery for cosmetic enhancement and breathing improvement by expert surgeons.',
  ...
  },
  {
    ...
    overview: 'Permanent tooth replacement using titanium implants with complete solutions from extraction to final restoration.',
  ...
  },
  {
    ...
    overview: 'Endoscopic sinus surgery for chronic sinusitis and nasal polyps using minimally invasive techniques.',
  ...
  },
  {
    ...
    overview: 'Advanced laser vision correction using state-of-the-art technology for precise corneal reshaping and clear vision.',
  ...
  },
  {
    ...
    overview: 'Diagnostic and therapeutic colonoscopy for colon health screening with comprehensive GI care.',
  ...
  },
  {
    ...
    overview: 'Minimally invasive hysterectomy with laparoscopic and robotic approaches for comprehensive gynecological care.',
  ...
  {
    id: '18',
    slug: 'dialysis-treatment',
    title: 'Dialysis Treatment',
    category: 'Nephrology Treatment',
    overview: 'Advanced hemodialysis and peritoneal dialysis for kidney failure with comprehensive renal care.',
  ...
  },
  {
    ...
    overview: 'Life-saving liver transplant surgery with complete pre-transplant evaluation and post-transplant care by expert surgeons.',
  ...
  {
    id: '20',
    slug: 'robotic-prostatectomy',
    title: 'Robotic Prostatectomy',
    category: 'Robotic Surgery',
    overview: 'Da Vinci robotic surgery for prostate cancer with enhanced precision and minimal invasiveness for optimal outcomes.',
  ...
  },
  {
    ...
    category: 'Stem Cell Therapy',
    overview: 'Regenerative medicine using stem cells for orthopedic injuries, autoimmune disorders, and degenerative diseases.',
  ...
  },
  {
    ...
    overview: 'Weight loss surgery with comprehensive weight management solutions including gastric bypass and sleeve gastrectomy.',
