...
export default function InfrastructureSection({ hospital }: InfrastructureSectionProps) {
    ...
    <section className="py-16 bg-gray-50 px-3 xs:px-4 sm:px-6 lg:px-10">
      <div className="container mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900">Infrastructure Details</h2>
            <p className="text-gray-600 mt-1">State-of-the-art infrastructure and resources</p>
          </div>
        </div>
