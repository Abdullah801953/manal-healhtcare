...
export function AboutHero() {
  return (
    <section className="relative bg-gradient-to-r from-emerald-500 via-teal-500 to-green-500 py-20 overflow-hidden">
      
      <div className="mx-6 grid lg:grid-cols-2 gap-12 items-center">
